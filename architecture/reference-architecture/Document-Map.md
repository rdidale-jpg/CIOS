...
| FP-013 | [Executive Intelligence Workspace](../founding-papers/FP-013-Executive-Intelligence-Workspace.md) | Establishes the proposed executive-first product experience for inspecting governed Enterprise Intelligence. | Proposed | `architecture/founding-papers/` | Review navigation only; owns experience doctrine, not canonical models, governance semantics, runtime or production-profile membership. |
| FP-014 | [Mission-Aware Executive Intelligence Composition](../founding-papers/FP-014-Mission-Aware-Executive-Intelligence-Composition.md) | Extends FP-013 with proposed Commercial Mission composition and evidence-led Reinvention Timing around common inspection. | Proposed | `architecture/founding-papers/` | Review navigation only; documentation-only and non-runtime; does not alter governed intelligence or introduce canonical models. |
...
| Document | Purpose | Status | Folder | Relationship to Reference Architecture |
| --- | --- | --- | --- | --- |
| [Banking Strategic Sales Navigation Specification](../../enterprise-knowledge/banking/flora/Banking-Strategic-Sales-Navigation-Specification.md) | Defines the Banking Strategic Sales Director journey, Explore/Focus/Shape modes, evidence controls and next-action contract. | Candidate | `enterprise-knowledge/banking/flora/` | Banking knowledge asset `BK-FLR-SSN-SPEC-001`; authoritative input to FEIR-001 reconciliation, not cross-industry architecture authority. |
| [Banking Strategic Sales Navigation Validation Report](../../enterprise-knowledge/banking/governance-reports/Banking-Strategic-Sales-Navigation-Validation-Report.md) | Validates Banking readiness and gaps for Strategic Sales navigation. | Candidate | `enterprise-knowledge/banking/governance-reports/` | Banking governance asset `BK-GOV-SSN-VAL-001`; informs FEIR-001 Banking journey and runtime readiness boundaries. |
| [Banking Strategic Sales Navigation Completion Report](../../enterprise-knowledge/banking/governance-reports/Banking-Strategic-Sales-Navigation-Completion-Report.md) | Records the Banking Strategic Sales Navigation commission result. | Candidate | `enterprise-knowledge/banking/governance-reports/` | Banking governance asset `BK-GOV-SSN-COMP-001`; confirms original Banking assets created in commit b0e5bf4. |
...
| EIRP-001 | [Enterprise Intelligence Reasoning Pipeline Specification](../specifications/flora/EIRP-001-Enterprise-Intelligence-Reasoning-Pipeline-Specification.md) | Defines the proposed subordinate Flora reasoning pipeline under ADR-024 and FEIR-001, including typed stage contracts, runtime object contracts, lineage, validation, recommendation eligibility and a Banking walkthrough. | Proposed | `architecture/specifications/flora/` | Operational reasoning contract only; preserves FEIR-001 as owning runtime architecture and requires future policy decisions for thresholds, persistence and approvals. |
| FEIR-001 | [Flora Enterprise Intelligence Runtime Architecture v1.0](../specifications/flora/FEIR-001-Flora-Enterprise-Intelligence-Runtime-Architecture-v1.0.md) | Defines the proposed owning Flora hybrid Enterprise Intelligence runtime architecture, worker model, validation controls, write-back flow and Strategic Sales contract under accepted ADR-024. | Proposed | `architecture/specifications/flora/` | Reconciled against Banking Strategic Sales Navigation assets; preserves accepted ADR-014 and Enterprise Intelligence ownership boundaries pending specification acceptance. |
| UX-001 | [Flora UK Banking → Lloyds Reference Journey](../UX-001-Flora-UK-Banking-Lloyds-Reference-Journey.md) | Defines the first numbered Flora UX journey specification for a UK Banking APP Fraud to Lloyds opportunity validation path. | Proposed | `architecture/` | Subordinate UX journey specification under the proposed Flora workspace product architecture and ADR-025; documentation-only and not architecture authority. |
