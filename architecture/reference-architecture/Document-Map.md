...
| OT-001 | [Opportunity Twin Specification](../specifications/opportunities/OT-001-Opportunity-Twin-Specification.md) | Defines the proposed durable, evidence-governed Opportunity Twin object subordinate to EI-006. | Review | `architecture/specifications/opportunities/` | Documentation-only subordinate specification; reconciles opportunity memory, lifecycle, Decision Envelopes, positioning interfaces and Provider Fit boundaries without replacing EI-006. |
