...
- guidance;
- up to one other material financial change.
...
Return no more than 5 facts total. Keep facts factual, atomic and page-grounded. Do not produce narrative summaries, Signals, Insights, Hypotheses or Recommendations. Return no fact when the source does not explicitly support it.
