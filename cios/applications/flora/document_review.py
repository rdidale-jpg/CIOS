...
def _outcome_summary(run: dict[str, Any] | None, show_support_control: bool = False) -> str:
    ...
    support_link = f" · <a class='support-report-link' href='/financial-intelligence/{escape(run['run_id'])}/support-report/download'>Download support report</a>" if show_support_control else ''
