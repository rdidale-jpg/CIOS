...
def _page(title: str, body: str) -> str:
    ...
    </style></head><body><div class='shell'><nav class='nav'><a href='/'>Morning Edition</a><a href='/observatory'>Observatory</a><a href='/radar'>Portfolio Radar</a><a href='/scoring'>Scoring Model</a><a href='/live'>Live Evidence</a><a href='/logbook'>Teach Flora / Pilot Logbook</a><a href='/settings'>Commercial DNA</a></nav>{body}</div></body></html>"""
