...
def _staticize_root_page(html: str) -> str:
    html = (
        ...
        .replace("href='/digital-twins'", "href='#digital-twins'")
        ...
        .replace("href='/evidence'", "href='#evidence'")
...
def _staticize_case_page(html: str) -> str:
    html = (
        ...
        .replace("href='/logbook'", "href='../logbook.html'")
        .replace("href='/settings'", "href='../settings.html'")
        .replace("href='/digital-twins/bt-group-plc'", "href='../index.html#digital-twin-bt-group-plc'")
        .replace("href='/digital-twins'", "href='../index.html#digital-twins'")
        ...
        .replace("href='/evidence'", "href='../index.html#evidence'")
