...
def build_publication_context(publication_date: date | None = None) -> dict[str, Any]:
    ...
    live_banner = f"LIVE EVIDENCE USED — {len(live_evidence)} evidence objects from {live_sources} sources" if live_evidence else "NO LIVE EVIDENCE AVAILABLE — use /live/collect to attempt collection"
