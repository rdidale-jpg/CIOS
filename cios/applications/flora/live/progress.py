...
def start_state(total: int, *, run_id: str | None = None, canonical_enterprise_id: str | None = None, enterprise_display_name: str | None = None, profile_id: str | None = None, collection_mode: str | None = None, collection_pass: str | None = None) -> dict[str, Any]:
    now = datetime.now(UTC).isoformat(timespec="seconds")
    return write_state({**default_state(), "run_id": run_id or uuid.uuid4().hex[:12], "started_at": now, "status":"running", "canonical_enterprise_id": canonical_enterprise_id or "", "enterprise_display_name": enterprise_display_name or "", "profile_id": profile_id or "", "collection_mode": collection_mode or "", "collection_pass": collection_pass or "", "sources_total": total, "latest_message":"Collection started."})
