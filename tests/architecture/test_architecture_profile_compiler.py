...
def test_compiler_parses_registry_rows() -> None:
    ...
    assert {"AP-001", "AP-002", "RP-001", "RP-002", "EIF-001", "EOD-001", "EU-001", "OT-001", "EI-014", "EI-015", "EI-017", "FP-010", "OPI-001", "RTP-001", "ADR-023", "VAL-ROADMAP-001"}.issubset(ids)
...
def test_fp013_is_discoverable_for_review_and_excluded_from_production() -> None:
    review = compile_architecture_profile("review-context", ROOT)
    document = next(document for document in review.included_documents if document.document_id == "FP-013")
