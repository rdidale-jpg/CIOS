...
def test_compiler_parses_registry_rows() -> None:
    ...
    assert {"AP-001", "AP-002", "RP-001", "RP-002", "EIF-001", "EOD-001", "EU-001", "OT-001", "OPI-001", "RTP-001", "ADR-023", "VAL-ROADMAP-001"}.issubset(ids)
...
def test_architecture_authority_profile_includes_only_accepted_authority() -> None:
    ...
    assert {"EIF-001", "EOD-001", "EU-001", "OT-001", "OPI-001", "RTP-001", "ADR-023", "VAL-ROADMAP-001"}.issubset(excluded_ids)
...
def test_review_context_preserves_review_and_proposed_statuses() -> None:
    ...
    assert status_by_id == {"EIF-001": "Review", "EOD-001": "Review", "EU-001": "Review", "OT-001": "Review", "OPI-001": "Review", "RTP-001": "Review", "ADR-023": "Proposed", "VAL-ROADMAP-001": "Review"}
