# Nationwide / Virgin Money Enterprise Twin Assets

## Purpose

This directory contains governed Banking Enterprise Twin assets for Nationwide / Virgin Money.

## Asset types that belong here

Enterprise Twin, Future Enterprise Model, enterprise-specific mechanism evidence and enterprise-scoped supporting research registers.
...
```text
Asset ID:
Asset Type: Enterprise Twin
Domain: Banking
Enterprise: Nationwide / Virgin Money
Version:
Status:
Evidence Cut-off:
Produced By:
...
- [Nationwide-Virgin-Money-Enterprise-Twin.md](Nationwide-Virgin-Money-Enterprise-Twin.md)
