# Banking Flora Discovery Assets

## Purpose

This directory contains human-readable and machine-readable Flora discovery metadata for governed Banking knowledge assets.

## Asset types that belong here

knowledge registers, machine manifests and Flora usage metadata.

## What must not be placed here

Do not place full research documents, unregistered runtime ingestion payloads, architecture papers, ADRs, doctrine or runtime specifications here. Research reports must not be treated as automatically accepted facts.
