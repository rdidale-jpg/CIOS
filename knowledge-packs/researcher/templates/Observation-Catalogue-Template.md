# Observation Catalogue Template

**Document ID:** TEMPLATE-Observation-Catalogue  
...
Provide the smallest operational shape for Observation Catalogue output without creating new doctrine.
