# Procurement Catalogue Template

**Document ID:** TEMPLATE-Procurement-Catalogue  
...
Provide the smallest operational shape for Procurement Catalogue output without creating new doctrine.
