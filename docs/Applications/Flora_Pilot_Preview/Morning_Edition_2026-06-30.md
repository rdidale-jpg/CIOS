...
**Generated:** 2026-06-29 16:49:09 UTC

## NO LIVE EVIDENCE AVAILABLE — FALLING BACK TO SEEDED PILOT EVIDENCE

Seeded pilot evidence is used because no local live evidence JSONL was found.
...
Pilot movement is visible in the seeded weekly comparison. Live evidence receipts are shown first when locally available; otherwise these changes should guide review priorities rather than be read as real-world freshness.
...
- Live evidence v0.1 reads only configured public HTML pages; it does not ingest PDFs yet.
- No broad crawling is used.
...
## Known Limitations
- Live evidence limited to configured public HTML source pages
