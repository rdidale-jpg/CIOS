# CIOS Master Document Index

This index is the authoritative catalogue for controlled CIOS Knowledge Library documents. Each entry records the document identifier, title, status, version and repository location.

| Document ID | Title | Status | Version | Location |
|---|---|---|---|---|
| CIOS-CON-001 | CIOS Constitution | Planned | 0.1.0 | `docs/Constitution/` |
| CIOS-SCI-001 | Commercial Science Registry | Proposed | 0.1.0 | `docs/Science/README.md` |
| CIOS-SCI-GOV | Science Governance | Proposed | 0.1.0 | `docs/Science/SCIENCE_GOVERNANCE.md` |
| CIOS-SCI-LAW-REG | Law Registry | Proposed | 0.1.0 | `docs/Science/LAW_REGISTRY.md` |
| CIOS-SCI-PRI-REG | Principle Registry | Proposed | 0.1.0 | `docs/Science/PRINCIPLE_REGISTRY.md` |
| CIOS-SCI-MOD-REG | Model Registry | Proposed | 0.1.0 | `docs/Science/MODEL_REGISTRY.md` |
| CIOS-SCI-HEU-REG | Heuristic Registry | Proposed | 0.1.0 | `docs/Science/HEURISTIC_REGISTRY.md` |
